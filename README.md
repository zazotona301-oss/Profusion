...
يعالج زر الرجوع في Android الإغلاق بالترتيب التالي: نافذة التصوير، نافذة إضافة المريض، القائمة الجانبية، ثم العودة إلى لوحة «نظرة عامة» قبل الخروج من التطبيق. توجد أصول الأيقونات الجاهزة والقابلة للاستبدال داخل [`public/assets/icons`](./public/assets/icons)، ويشرح ملف README هناك أسماء الملفات والمقاسات والمسارات الموصى بها.
